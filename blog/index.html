...
<header id="cabecalho">
  <a id="logo" href="index.html" aria-label="Abrir Menu" aria-haspopup="true" aria-controls="menu" aria-expanded="false"title="Blog Douglas Reis"><img src="img/logoblog_bnw.png"></a>
  <nav id="menu">
