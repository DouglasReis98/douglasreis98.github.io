...
<link rel="stylesheet" type="text/css" href="slide/js/style-slide.css" />
<script type="text/javascript" src="slide/js/jquery-1.11.3.min.js"></script>
<script type="text/javascript" src="slide/js/jquery.cycle.all.js"></script>
...
<div id="slideshow">
<ul id="nav">
<li id="previous"><a href="#"><img src="slide/imgs/prev.png" width="50" height="50"></a></li>
<li id="next"><a href="#"><img src="slide/imgs/next.png" width="50" height="50" /></a></li>
</ul>
<ul id="slide">
<ul>
    <li><img src="slide/imgs/capa_facebook_gabriel_lima.png" width="800" height="400" title="Capa de Facebook"  /></li>
    <li><img src="slide/imgs/capacd_gabriel_lima_01.png" width="800" height="400" title="Capa de CD" /></li>
    <li><img src="slide/imgs/wrestlemania-XXX.png" width="800" height="400" title="Logo Wrestlemania" /></li>
</ul>
</ul>
</div>
</div>
