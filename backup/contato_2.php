...
<div id="divconteudo">
<div id="conteudo"><!-- InstanceBeginEditable name="Conteúdo" --><h1>Contato</h1>
<?
...
{
echo "Existe(m) campo(s) de preenchemento em branco,<BR>
Retorne e preencha-o(s).";
echo "<BR> <a href=\"contato.php\"> Clique aqui para tentar novamente</a>";
}
